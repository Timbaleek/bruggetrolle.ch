<script>
  ...
  onDestroy(() => {
    // onDestroy still fires during SSR (there's no browser there), so
    // guard every `document` access or the initial render of any page
    // that uses this component will 500.
